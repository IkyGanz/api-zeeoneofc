...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'IkyGanz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'IkyGanz') return res.json(loghandler.invalidKey)
...
router.get('/random/wallpaper', async (req, res, next) => {
	...
	if(apikeyInput != 'IkyGanz') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-zahirrr.IkyGanzherokuapp.com/api/random/wallpaper?genre=acak`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
